...
INCLUDE   += -I./utils -I./pay
LOCAL_SRC += utils/HttpClient.cpp utils/RSAUtils.cpp pay/AliPay.cpp pay/WePay.cpp pay/IosPay.cpp
...
143:
	sshpass -p 'awzs2023' scp ./OrderServer root@10.10.10.143:/home/yuj/server/orderserver
